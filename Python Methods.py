...
# 🔹 File Object Methods
close(), detach(), fileno(), flush(), isatty(), read(), readable(), readline(), readlines(), seek(), seekable(), 
...
__next__(), __contains__(), __call__(), __enter__(), __exit__(), __add__(), __sub__(), __mul__(), __truediv__(), 
__eq__(), __lt__(), __gt__(), __hash__(), __bool__()

# 🔹 Class/Object Related
@classmethod, @staticmethod, __new__, __del__, __getattr__

...
# Abstraction is the process of hiding the implementation details of a class and showing only 
# the necessary details to the user. 
# It is a way to reduce the complexity of a program and make it easier to understand and maintain.
